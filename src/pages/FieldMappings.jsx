    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div className="flex-1">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Mapeamentos de Campos</h1>
          {endpoint && (
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <button
                ...
                className="btn btn-secondary flex items-center space-x-2 text-sm whitespace-nowrap"
            ...
            <>
              ...
              <div className="grid grid-cols-1 gap-4 md:hidden">
                {filteredMappings.map((mapping) => (
                  <div key={mapping.id} className="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
